...
/**
 * very basic version (only filter based on independent conditions)
 * please note that reading records from the byte file is
 * faster than reading data from strings file.
 * thus, we store record in byte array rather than raw string
...
public class FullScan {
    ...
    private final Map<String, Integer> typeCountMap;
