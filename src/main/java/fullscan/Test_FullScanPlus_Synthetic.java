...
public class Test_FullScanPlus_Synthetic {
    ...
    public static long storeEvents(String filePath, FullScanPlus fullScan){
        ...
        // System.out.println("build cost: " + (endBuildTime - startBuildTime) +"ms");
    ...
    public static void batchQuery(FullScanPlus fullScan, JSONArray jsonArray, MatchEngine engine){
        ...
        int queryNum = jsonArray.size();// queryNum = 500
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Test_FullScanPlus_Synthetic.createSchema();
        // 2. create fullScan Object
        FullScanPlus fullScan = Test_FullScanPlus_Synthetic.createFullScan();
        // 3. store events
        ...
        long buildCost = Test_FullScanPlus_Synthetic.storeEvents(dataFilePath, fullScan);
        ...
        for(int i = 0; i < 1; ++i){
            ...
            String outputFilePath = prefixPath + "output" + sep + "fullscanplus_" + filename + "_nfa_query" + (i+1) + ".txt";
            ...
            Test_FullScanPlus_Synthetic.batchQuery(fullScan, jsonArray, engine);
        }
    }
}
